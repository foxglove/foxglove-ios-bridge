...
extension Foxglove_Point2: @unchecked Sendable {}
...
extension Foxglove_Point2: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Foxglove_Point2, rhs: Foxglove_Point2) -> Bool {
