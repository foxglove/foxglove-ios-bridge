...
struct Foxglove_Pose {
  ...
  var position: Foxglove_Vector3 {
    get { _position ?? Foxglove_Vector3() }
  ...
  var orientation: Foxglove_Quaternion {
    get { _orientation ?? Foxglove_Quaternion() }
    set { _orientation = newValue }
  }

  /// Returns true if `orientation` has been explicitly set.
  var hasOrientation: Bool { _orientation != nil }
  /// Clears the value of `orientation`. Subsequent reads from it will return its default value.
  mutating func clearOrientation() { _orientation = nil }

  var unknownFields = SwiftProtobuf.UnknownStorage()

  init() {}

  private var _position: Foxglove_Vector3?
  private var _orientation: Foxglove_Quaternion?
}
...
extension Foxglove_Pose: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase,
  SwiftProtobuf._ProtoNameProviding
{
  ...
  mutating func decodeMessage(decoder: inout some SwiftProtobuf.Decoder) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeSingularMessageField(value: &_orientation)
      default: break
      }
    }
  }
